            ...
            for (var M, z, P, k = i.slidesPerColumn, L = T / k, $ = Math.floor(c / i.slidesPerColumn), I = 0; I < c; I += 1) {
              ...
              if ("none" !== O.css("display")) {
                if ("auto" === i.slidesPerView) {
                  ...
                  (S = (r - (i.slidesPerView - 1) * w) / i.slidesPerView), i.roundLengths && (S = Math.floor(S)), p[I] && (p[I].style[t("width")] = S + "px");
  ...
  var K = {
    ...
    he = [
      ...
      },
      {
        ...
        create: function () {
          M(this, {
            a11y: t({}, se, { liveRegion: m('<span class="' + this.params.a11y.notificationClass + '" aria-live="assertive" aria-atomic="true"></span>') }),
          });
        },
        on: {
