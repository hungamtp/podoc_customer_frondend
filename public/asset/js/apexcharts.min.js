          ...
          [
            ...
            },
            {
              ...
              value: function (t, e) {
                ...
                return (
                  "#" +
                  (16777216 + 65536 * (Math.round((a - r) * s) + r) + 256 * (Math.round((a - n) * s) + n) + (Math.round((a - o) * s) + o)).toString(16).slice(1)
                );
              },
            },
            {
          ...
          },
          {
            ...
            value: function (t, e) {
              ...
              "vertical" === e.label.orientation &&
                ((o = e.label.style.padding.left), (l = e.label.style.padding.right), (r = e.label.style.padding.top), (n = e.label.style.padding.bottom));
          ...
          },
          {
            ...
            value: function (t) {
              ...
              return (
                ...
                i && o.globals.memory.methodsToExec.push({ context: n, id: g.id ? g.id : f.randomId(), method: r, label: "addAnnotation", params: e }),
                a
              );
            },
          },
        ...
        a(t, [
          ...
          },
          {
            ...
            value: function (t, e, i) {
              ...
              var d =
                void 0 === s.fill.gradient.opacityTo ? e : Array.isArray(s.fill.gradient.opacityTo) ? s.fill.gradient.opacityTo[i] : s.fill.gradient.opacityTo;
            ...
            value: function (t, e, i, a) {
              ...
              if (
                ((n.globals.markers.size[e] > 0 || r) &&
                  (h = c.group({ class: r ? "" : "apexcharts-series-markers" })).attr("clip-path", "url(#gridRectMarkerMask".concat(n.globals.cuid, ")")),
                Array.isArray(l.x))
              )
              ...
              if (
                ("circle" === m.shape
                  ...
                  : ("square" !== m.shape && "rect" !== m.shape) ||
                    (o = f.drawRect(0, 0, m.width - m.pointStrokeWidth / 2, m.height - m.pointStrokeWidth / 2, m.pRadius)),
            ...
            value: function (t, e, i) {
              ...
              return (
                ...
                s.config.stroke.show &&
                  (this.barCtx.isNullValue || (a = Array.isArray(this.barCtx.strokeWidth) ? this.barCtx.strokeWidth[i] : this.barCtx.strokeWidth)),
                a
              );
            },
          },
          ...
          },
          {
            ...
            value: function (t) {
              ...
              return (
                ...
                d.config.chart.stacked &&
                  (this.barCtx.yArrj.push(f.y2), this.barCtx.yArrjF.push(Math.abs(s - f.y2)), this.barCtx.yArrjVal.push(this.barCtx.series[h][c])),
                { pathTo: m, pathFrom: v }
              );
            },
          },
            ...
            value: function (t) {
              ...
              return (
                ...
                c.config.chart.stacked &&
                  (this.barCtx.xArrj.push(u.x2), this.barCtx.xArrjF.push(Math.abs(a - u.x2)), this.barCtx.xArrjVal.push(this.barCtx.series[l][h])),
                { pathTo: f, pathFrom: p }
              );
            },
          },
        ...
        a(t, [
          ...
          },
          {
            ...
            value: function (t, e) {
              ...
              e = (e = (e = (e = e.replace(/(^|[^\\])HH+/g, "$1" + l(u))).replace(/(^|[^\\])H/g, "$1" + u)).replace(/(^|[^\\])hh+/g, "$1" + l(f))).replace(
                /(^|[^\\])h/g,
                "$1" + f
              );
          ...
          },
          {
            ...
            value: function (t) {
              ...
              "function" == typeof g && (c = g(c, u)),
                Number.isFinite(s) &&
                  Number.isFinite(r) &&
                  ((o = s), (l = r), n.config.series[i].data[a].x && (h = n.config.series[i].data[a].x + ":"), "function" == typeof d && (h = d(h, u)));
              var f = "",
                p = "",
          ...
          },
          {
            ...
            value: function () {
              return {
                ...
                fill: {
                  gradient: { shade: "dark", shadeIntensity: 0.4, inverseColors: !1, type: "diagonal2", opacityFrom: 1, opacityTo: 1, stops: [70, 98, 100] },
                },
              ...
              if ("array" === t)
                ...
                for (var g = 0; g < e[i].data.length; g++)
                  Array.isArray(e[i].data[g].y) &&
                    ...
                    s
                      ? (o.push(e[i].data[g].y[2]), l.push(e[i].data[g].y[3]), h.push(e[i].data[g].y[4]))
              ...
              for (
                ...
                if (
                  ...
                  this.isFormat2DArray() ? this.handleFormat2DArray(t, l) : this.isFormatXY() && this.handleFormatXY(t, l),
                    ("candlestick" !== a.chart.type && "candlestick" !== t[l].type && "boxPlot" !== a.chart.type && "boxPlot" !== t[l].type) ||
          ...
          },
          {
            ...
            value: function (t) {
              var e = this.w,
                i = new y(this.ctx);
              return (
                !e.config.yaxis[t].show || (!e.config.yaxis[t].showForNullSeries && i.isSeriesNull(t) && -1 === e.globals.collapsedSeriesIndices.indexOf(t))
              );
            },
          },
          {
                ...
                g = function (t) {
                  ...
                  if (n.globals.axisCharts) {
                    ...
                    "datetime" === n.config.xaxis.type &&
                      (n.config.xaxis.categories.length ? (i = n.config.xaxis.categories[t]) : n.config.labels.length && (i = n.config.labels[t]));
            ...
            value: function () {
              ...
              return (
                !t.globals.isBarHorizontal || this.isTimelineBar
                  ? ((i = this.xaxisLabels.length),
                    this.isTimelineBar &&
                      ((a = t.globals.labels.length), t.config.xaxis.tickAmount && t.config.xaxis.labels.formatter && (i = t.config.xaxis.tickAmount)),
            ...
            value: function () {
              ...
              if (
                ...
                t.noLabelsProvided &&
                  ...
                  ((t.maxX = t.labels[t.labels.length - 1]), (t.initialMaxX = t.labels[t.labels.length - 1]), (t.minX = 1), (t.initialMinX = 1)),
            ...
            value: function () {
              ...
              if ((e.config.xaxis.convertedCatToNumeric && 0 === i.length && (i = e.globals.categoryLabels), e.globals.timescaleLabels.length > 0)) {
                ...
                this.dCtx.lgWidthForSideLegends =
                  ("left" !== e.config.legend.position && "right" !== e.config.legend.position) || e.config.legend.floating ? 0 : this.dCtx.lgRect.width;
                ...
                e.config.yaxis.map(function (r, n) {
                  ...
                  if (!s.isYAxisHidden(n) && r.labels.show && o.result.length) {
                    ...
                    var u = new b(t.dCtx.ctx),
                      ...
                      m = x;
                    c !== d && (m = u.getTextRects(d, r.labels.style.fontSize, r.labels.style.fontFamily, p, !1)),
                      i.push({ width: (m.width > x.width ? m.width : x.width) + a, height: m.height > x.height ? m.height : x.height });
          ...
          },
          {
            ...
            value: function () {
              ...
              var c = function () {
                (i.translateX = o),
                  (i.gridHeight =
                    i.svgHeight - t.lgRect.height - l - (t.isSparkline || "treemap" === e.config.chart.type ? 0 : e.globals.rotateXLabels ? 10 : 15)),
        ...
        a(t, [
          ...
          },
          {
            ...
            value: function () {
              ...
              for (
                var n = e.globals.legendFormatter, o = e.config.legend.inverseOrder, l = o ? a.length - 1 : 0;
                o ? l >= 0 : l <= a.length - 1;
                o ? l-- : l++
              ) {
              ...
              var r = [],
                n = function (i, a, s) {
                  ...
                  t.t[n] &&
                    ...
                    r.push({ el: a, icon: "string" == typeof t.t[n] ? t.t[n] : s, title: t.localeValues[i], class: "apexcharts-".concat(n, "-icon") });
                };
              n(
                "zoomIn",
                this.elZoomIn,
          ...
          },
          {
            ...
            value: function (t, e) {
              ...
              if (
                ...
                if (
                  ((a.clientX =
                    "touchmove" === e.type || "touchstart" === e.type ? e.touches[0].clientX : "touchend" === e.type ? e.changedTouches[0].clientX : e.clientX),
                  (a.clientY =
                    "touchmove" === e.type || "touchstart" === e.type ? e.touches[0].clientY : "touchend" === e.type ? e.changedTouches[0].clientY : e.clientY),
          ...
          },
          {
            ...
            value: function (t, e, i) {
              ...
              this.ctx.updateHelpers._updateOptions(t, !1, !1),
                "function" == typeof a.config.chart.events.scrolled && a.config.chart.events.scrolled(this.ctx, { xaxis: { min: e, max: i } });
            },
          },
        ]),
        s
            ...
            value: function (t) {
              ...
              return (
                ...
                r.globals.isXNumeric &&
                  ...
                  (p = v.j),
                  null !== m && ((y = r.globals.seriesXvalues[m]), (p = (v = this.closestInArray(g, y)).index))),
                ...
                var x = function (t, r) {
                    ...
                    (f = i.getSeriesName({ fn: x.yLbTitleFormatter, index: a, seriesIndex: a, j: s })),
                      "treemap" === c.config.chart.type &&
                        (f = x.yLbTitleFormatter(String(c.config.series[a].data[s].x), { series: c.globals.series, seriesIndex: a, dataPointIndex: s, w: c }));
                    ...
                    if (c.globals.axisCharts) {
                      ...
                      l
                        ? ((x = i.getFormatters(b)),
                          (f = i.getSeriesName({ fn: x.yLbTitleFormatter, index: b, seriesIndex: a, j: s })),
          ...
          },
          {
            ...
            value: function (t) {
              ...
              u[0] &&
                ...
                (o.config.tooltip.marker.fillColors && Array.isArray(o.config.tooltip.marker.fillColors) && (n = o.config.tooltip.marker.fillColors[e]),
            ...
            value: function (t, e) {
              ...
              if (
                ...
                a.globals.isBarHorizontal
                  ? (h -= n.ttHeight)
                  : (n.ttHeight / 2 + h > a.globals.gridHeight && (h = a.globals.gridHeight - n.ttHeight + a.globals.translateY), h < 0 && (h = 0));
            ...
            value: function (t) {
              ...
              if (
                (e.globals.isXNumeric
                  ? ((n -= a % 2 != 0 ? l / 2 : 0),
                    (r.classList.contains("apexcharts-candlestick-area") || r.classList.contains("apexcharts-boxPlot-area")) &&
            ...
            value: function () {
              ...
              if (
                ...
                (s
                  ...
                  : ("heatmap" !== e && "treemap" !== e) ||
                    (o = t.globals.dom.baseEl.querySelectorAll(".apexcharts-series .apexcharts-heatmap, .apexcharts-series .apexcharts-treemap")),
                o && o.length)
              )
          ...
          },
          {
            ...
            value: function (t) {
              ...
              void 0 === this.series[h][c] || null === this.series[h][c]
                ? ((w = r), (k = r))
                : ((w = r - w / p), (k = r - k / p), (v = r - m.h / p), (y = r - m.l / p), (A = r - m.m / p));
              var C = l.move(S, r),
                L = l.move(S + s / 2, w);
              return (
            ...
            value: function (t, e) {
              ...
              for (var d = 0; d < t.length; d++) {
                ...
                this.addListeners(v, this.donutDataLabels),
                  b.setAttrs(v.node, { "data:angle": u, "data:startAngle": o, "data:strokeWidth": this.strokeWidth, "data:value": e[d] });
                var w = { x: 0, y: 0 };
                  ...
                  for (var m = 0; m < c.linePathsTo.length; m++) {
                    ...
                    var y = a.fillPath({ seriesNumber: o }),
                      w = e.graphics.renderPaths(
                        n(n({}, d), {}, { pathFrom: null === b ? c.areaPathsFrom[m] : b, pathTo: c.areaPathsTo[m], strokeWidth: 0, fill: y, drawShadow: !1 })
                      );
          ...
          },
          {
            ...
            value: function (t) {
              ...
              var o = e.config.plotOptions.radialBar.hollow.background,
                l =
                  t.size - n * t.series.length - this.margin * t.series.length - (n * parseInt(e.config.plotOptions.radialBar.track.strokeWidth, 10)) / 100 / 2,
              ...
              this.radialDataLabels.show &&
                (u = this.renderInnerDataLabels(this.radialDataLabels, { hollowSize: l, centerX: t.centerX, centerY: t.centerY, opacity: g })),
            ...
            value: function (t) {
              ...
              if ("area" === e)
                for (var c = l.fillPath({ seriesNumber: i }), d = 0; d < s.areaPaths.length; d++) {
                  var g = o.renderPaths(
                    n(n({}, h), {}, { pathFrom: s.pathFromArea, pathTo: s.areaPaths[d], stroke: "none", strokeWidth: 0, strokeLineCap: null, fill: c })
                  );
                  this.elSeries.add(g);
                }
        ...
        a(t, [
          ...
          },
          {
            ...
            value: function (t) {
              ...
              return (
                (i = t[2] - t[0]), (a = t[3] - t[1]), (s = i * a), (r = Math.pow(s, 0.5)), Math.min(r / n, parseInt(e.config.dataLabels.style.fontSize, 10))
              );
            },
          },
          {
            ...
            value: function (t) {
              ...
              if (e.minDate > 1 || e.minMonth > 0) {
                ...
                (o = (l.determineDaysOfYear(e.minYear) - c + 1) * s),
                  (n = e.minYear + 1),
                  this.timeScaleArray.push({ position: o, value: n, unit: h, year: n, month: f.monthMod(i + 1) });
              ...
              for (var d = n, g = o, u = 0; u < r; u++)
                d++, (g = l.determineDaysOfYear(d - 1) * s + g), this.timeScaleArray.push({ position: g, value: d, unit: h, year: d, month: 1 });
            },
          },
          {
          ...
          },
          {
            ...
            value: function (t) {
              ...
              for (var m = c, v = 0; v < l; v++)
                g >= 60 && ((g = 0), 24 === (b += 1) && (b = 0)),
                  (m = n + m),
                  this.timeScaleArray.push({ position: m, value: g, unit: h, hour: b, minute: g, day: u, year: this._getYear(r, p, 0), month: f.monthMod(p) }),
                  g++;
            },
          },
          {
        ...
        a(t, [
          {
            ...
            value: function () {
              var t = this.w.globals,
                ...
                i = e.chart.type;
              (t.axisCharts =
                ["line", "area", "bar", "rangeBar", "candlestick", "boxPlot", "scatter", "bubble", "radar", "heatmap", "treemap"].indexOf(i) > -1),
          ...
          },
          {
            ...
            value: function (t) {
              (this.ctx.w.globals.selection = void 0),
                this.ctx.updateHelpers._updateOptions({ chart: { selection: { xaxis: { min: t.w.globals.minX, max: t.w.globals.maxX } } } }, !1, !1);
            },
          },
          {
              ...
              return (
                i.globals.axisCharts
                  ? (a = i.globals.dom.Paper.select(
                      "".concat(s, " path[j='").concat(e, "'], ").concat(s, " circle[j='").concat(e, "'], ").concat(s, " rect[j='").concat(e, "']")
                    ).members[0])
                  : void 0 === e &&
    ...
    (zt = function (e, i) {
      ...
      (a.did = 1e3),
        ...
        (a.invent = function (t) {
          ...
          return (
            t.inherit && (e.prototype = new t.inherit()), t.extend && a.extend(e, t.extend), t.construct && a.extend(t.parent || a.Container, t.construct), e
          );
        }),
        (a.adopt = function (t) {
          return t
              ...
              ("string" == typeof e
                ? a.regex.isRgb.test(e)
                  ...
                  : a.regex.isHex.test(e) &&
                    ((i = a.regex.hex.exec(
                      4 == (s = e).length
                        ? ["#", s.substring(1, 2), s.substring(1, 2), s.substring(2, 3), s.substring(2, 3), s.substring(3, 4), s.substring(3, 4)].join("")
                        : s
                    )),
      ...
      (a.PathArray = function (t, e) {
            ...
            (this.value = 0),
              ...
              "number" == typeof t
                ...
                ? (e = t.match(a.regex.numberAndUnit)) &&
                  ((this.value = parseFloat(e[1])), "%" == e[5] ? (this.value /= 100) : "s" == e[5] && (this.value *= 1e3), (this.unit = e[5]))
        ...
        (a.Element = a.invent({
          ...
          extend: {
            ...
            matches: function (t) {
              return (function (t, e) {
                return (t.matches || t.matchesSelector || t.msMatchesSelector || t.mozMatchesSelector || t.webkitMatchesSelector || t.oMatchesSelector).call(
                  t,
                  e
                );
              })(this.node, t);
        ...
        (a.Parent = a.invent({
          ...
          extend: {
            ...
            add: function (t, e) {
              return (
                null == e ? this.node.appendChild(t.node) : t.node != this.node.childNodes[e] && this.node.insertBefore(t.node, this.node.childNodes[e]), this
              );
            },
            put: function (t, e) {
        ...
        a.extend(a.Element, {
          ...
          fire: function (t, i) {
            return (
              t instanceof e.Event ? this.node.dispatchEvent(t) : this.node.dispatchEvent((t = new a.CustomEvent(t, { detail: i, cancelable: !0 }))),
              (this._event = t),
              this
            );
          },
    ...
    (function () {
      (function () {
        ...
        (t.prototype.transformPoint = function (t, e, i) {
          return (
            (this.p.x = t - (this.offset.x - window.pageXOffset)), (this.p.y = e - (this.offset.y - window.pageYOffset)), this.p.matrixTransform(i || this.m)
          );
        }),
        ...
        (window.removeResizeListener = function (t, i) {
          t &&
            ...
            t.__resizeListeners__.length ||
              (t.removeEventListener("scroll", e), t.__resizeTriggers__.parentNode && (t.__resizeTriggers__ = !t.removeChild(t.__resizeTriggers__))));
        });
    })(),
        ...
        [
          ...
          },
          {
            ...
            value: function (t, e) {
              ...
              if (
                (this.core.setupElements(), "treemap" === i.config.chart.type && ((i.config.grid.show = !1), (i.config.yaxis[0].show = !1)), 0 === a.svgWidth)
              )
