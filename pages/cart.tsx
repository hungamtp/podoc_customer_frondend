                ...
                <table className="table mb-0 table-center">
                  ...
                  <tbody>
                    ...
                    <tr className="shop-list">
                      ...
                      <td className="text-center qty-icons">
                        <button className="btn btn-icon btn-soft-primary minus">-</button>
                        <input min="0" name="quantity" value="1" type="number" className="btn btn-icon btn-soft-primary qty-btn quantity" />
                        <button className="btn btn-icon btn-soft-primary plus">+</button>
                      </td>
                    ...
                    <tr className="shop-list">
                      ...
                      <td className="text-center qty-icons">
                        <button className="btn btn-icon btn-soft-primary minus">-</button>
                        <input min="0" name="quantity" value="2" type="number" className="btn btn-icon btn-soft-primary qty-btn quantity" />
                        <button className="btn btn-icon btn-soft-primary plus">+</button>
                      </td>
          ...
          <div className="row">
            ...
            <div className="col-lg-4 col-md-6 ms-auto mt-4 pt-2">
              ...
              <div className="mt-4 pt-2 text-end">
                <a href="shop-checkouts.html" className="btn btn-primary">
                  Proceed to checkout
                </a>
              </div>
            </div>
