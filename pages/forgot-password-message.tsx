...
export default function ForgotPasswordMessage({}: Props) {
  // response from momo
              ...
              <div className="card login-page bg-white shadow rounded border-0">
                <div className="card-body">
                  <div className="text-center">
                    ...
                    <h1 className="my-4 fw-bold fs-4">Gửi link thành công</h1>
                    <p className="text-muted para-desc mx-auto ">
                      {`Chúng tôi đã gửi link để tạo mật khẩu mới cho bạn xin vui lòng kiểm tra email`}
                    </p>
...
ForgotPasswordMessage.LayOut = EmptyLayout;
