                  ...
                  <div className="col-lg-4 col-md-6 col-12 mt-4 pt-2">
                    <div className="card shop-list border-0 position-relative">
                      ...
                      <div className="shop-image position-relative overflow-hidden rounded shadow">
                        <a href="product-detail">
                          <img
                            src="asset/images/shop/product/s9.jpg"
                            className="img-fluid"
                            alt=""
                          />
                        </a>
                        <a href="product-detail" className="overlay-work">
                          <img
                            src="asset/images/shop/product/s-9.jpg"
                            className="img-fluid"
                            alt=""
                          />
                        </a>
                  ...
                  <div className="col-lg-4 col-md-6 col-12 mt-4 pt-2">
                    <div className="card shop-list border-0 position-relative">
                      ...
                      <div className="shop-image position-relative overflow-hidden rounded shadow">
                        <a href="product-detail">
                          <img
                            src="asset/images/shop/product/s10.jpg"
                            className="img-fluid"
                            alt=""
                          />
                        </a>
                  ...
                  <div className="col-lg-4 col-md-6 col-12 mt-4 pt-2">
                    <div className="card shop-list border-0 position-relative">
                      ...
                      <div className="shop-image position-relative overflow-hidden rounded shadow">
                        <a href="product-detail">
                          <img
                            src="asset/images/shop/product/s11.jpg"
                            className="img-fluid"
                            alt=""
                          />
                        </a>
                        <a href="product-detail" className="overlay-work">
                          <img
                            src="asset/images/shop/product/s-11.jpg"
                            className="img-fluid"
                            alt=""
                          />
                        </a>
                  ...
                  <div className="col-lg-4 col-md-6 col-12 mt-4 pt-2">
                    <div className="card shop-list border-0 position-relative">
                      ...
                      <div className="shop-image position-relative overflow-hidden rounded shadow">
                        <a href="product-detail">
                          <img
                            src="asset/images/shop/product/s12.jpg"
                            className="img-fluid"
                            alt=""
                          />
                        </a>
                        <a href="product-detail" className="overlay-work">
                          <img
                            src="asset/images/shop/product/s-12.jpg"
                            className="img-fluid"
                            alt=""
                          />
                        </a>
                  ...
                  <div className="col-lg-4 col-md-6 col-12 mt-4 pt-2">
                    <div className="card shop-list border-0 position-relative">
                      <div className="shop-image position-relative overflow-hidden rounded shadow">
                        <a href="product-detail">
                          <img
                            src="asset/images/shop/product/s13.jpg"
                            className="img-fluid"
                            alt=""
                          />
                        </a>
                        <a href="product-detail" className="overlay-work">
                          <img
                            src="asset/images/shop/product/s-13.jpg"
                            className="img-fluid"
                            alt=""
                          />
                        </a>
                  ...
                  <div className="col-lg-4 col-md-6 col-12 mt-4 pt-2">
                    <div className="card shop-list border-0 position-relative">
                      <div className="shop-image position-relative overflow-hidden rounded shadow">
                        <a href="product-detail">
                          <img
                            src="asset/images/shop/product/s14.jpg"
                            className="img-fluid"
                            alt=""
                          />
                        </a>
                        <a href="product-detail" className="overlay-work">
                          <img
                            src="asset/images/shop/product/s-14.jpg"
                            className="img-fluid"
                            alt=""
                          />
                        </a>
                  ...
                  <div className="col-lg-4 col-md-6 col-12 mt-4 pt-2">
                    <div className="card shop-list border-0 position-relative">
                      <div className="shop-image position-relative overflow-hidden rounded shadow">
                        <a href="product-detail">
                          <img
                            src="asset/images/shop/product/s15.jpg"
                            className="img-fluid"
                            alt=""
                          />
                        </a>
                        <a href="product-detail" className="overlay-work">
                          <img
                            src="asset/images/shop/product/s-15.jpg"
                            className="img-fluid"
                            alt=""
                          />
                        </a>
